...
//				logCycles(cpu, testCase, j);
				...
				{
					System.out.println("Test: " + testCase[j].getName() + " - " + "\033[0;32m" + "PASSED!" + "\033[0m");
				}
				else if (this.bTestPass == false && this.iVerbosity == 1)
				{
					System.out.println("Test: " + testCase[j].getName() + " - " + "\033[0;31m" + "FAIL!" + "\033[0m");
					this.bOverallPass = false;
				}
				else if (this.bTestPass == false && this.iVerbosity == 2)
				{
					this.log = "\033[0;31m" + "Discrepancies detected in below test!" + "\033[0m" + "\n" + log;
			...
			{
				System.out.println(Integer.toHexString(iSelection) + ".json - " + "\033[0;32m" + "PASSED!" + "\033[0m");
				iTestsPassed++;
			}
			else if (this.bOverallPass == false)
			{
				System.out.println(Integer.toHexString(iSelection) + ".json - " + "\033[0;31m" + "FAIL!" + "\033[0m");
			}
...
//	}
	...
	public static void main(String[] args)
	{
		...
		debugCPU debug = new debugCPU("D:\\NEAWorkspace\\AppleIEmulator\\Normal\\");
	}
}